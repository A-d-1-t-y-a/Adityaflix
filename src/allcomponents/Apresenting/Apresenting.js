  ...
  return (
    <div className="bg-black h-[100vh] items-center justify-center grid grid-cols-10 -z-10 p-2 gap-2 ">
      {/* <div className="absolute top-20 flex items-center n justify-center bottom-0 right-0 left-0 w-full p-20  bg-transprent z-10 ">
        <div className="mx-auto bg-transparent text-9xl text-white drop-shadow-md shadow-white font-serif font-extrabold  flex items-center">Happy Birthday</div>
      </div> */}
     
      {/* {[...Array(array).keys()].map((i)=>(<Animations key={i}  ani={animi[index]} gradient={images[Index]} content={"Sundari"}/>))} */}
  </div>
  )
}
